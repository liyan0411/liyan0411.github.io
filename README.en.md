...
```yml
# Site settings
title: Leey Blog             # title of your website
SEOTitle: Leey Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: liyan0411     # modify this account to yours
weibo_username: 小李子每天都在奋斗。      # the footer woule be auto-updated.
...
It's possible that you want the two things different. For me, my site-title is **“Leey Blog”** but I want the title shows in search engine is **“李岩的博客 | “Leey Blog”** which is multi-language.
